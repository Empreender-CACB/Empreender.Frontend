  ...
  return (
    <div className='flex justify-center items-center tracking-tight sm:w-45'>
      <div className=' bg-white sm:w-full lg:w-6/12' id="login">
        ...
        {diagnosticos && diagnosticos.map((diagnostico, index) => (
                        ...
                        <>
                          {fileUploads[quesito.idAnexo] ? (
                            <>
                              ...
                              <Button size="sm" loading={loading} onClick={() => handleSubmit(quesito.idAnexo)} variant="solid" color="green-600" className="ml-4">
                                Salvar
                              </Button>
                            </>
                          ) : (
